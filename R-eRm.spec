...
Version  : 0.16.1
Release  : 2
URL      : https://cran.r-project.org/src/contrib/eRm_0.16-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/eRm_0.16-1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530440184
